...
Commands.run = function (arg) {
    ...
    if (cmd === "help") {
        ...
        if (typeof myCommands[cmd].help === "function") {
            ...
            let helpText = myCommands[cmd].help(args, params);
    ...
    if (myCommands.hasOwnProperty(cmd) && typeof (myCommands[cmd].execute) === "function") {
...
Commands.addParameter("commands", Commands);
